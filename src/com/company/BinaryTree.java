...
public class BinaryTree {
    ...
    public static BinaryTree createRandomIntegerTree (int numNodes)
    {
    ...
    static void drawTree(BinaryTree root)
    {
        ...
        LinkedList<BinaryTree> q = new  LinkedList<BinaryTree> ();
        q.add(root.left);
        q.add(root.right);
    ...
    static void drawElement(BinaryTree ele, int depthChildCount[], int depth, LinkedList<BinaryTree> q)
    {
        if (ele == null)
            return;
        ...
        if (ele.level != currDrawLevel)
        {
            ...
            for (int i=0; i<(depth-ele.level+1); i++)
            {
                ...
                BinaryTree doneParent = ele.parent;
                for (BinaryTree sibling: q)
                {
                    if (sibling == null)
                        continue;
    ...
    public static int depth (BinaryTree n)
    {
        if (n == null)
            return 0;
    ...
    public static int countNodes (BinaryTree n)
    {
        if (n == null)
            return 0;
    ...
    static void setLevels (BinaryTree r, int level)
    {
        if (r == null)
            return;
        r.level = level;
